namespace Nwc.XmlRpc
{
  ...
  public class XmlRpcSerializer : XmlRpcXmlTokens
  {
    ...
    public String Serialize(Object obj)
      {
	StringWriter strBuf = new StringWriterWithEncoding(System.Text.Encoding.UTF8);
	...
	if (obj is byte[])
	  ...
	  {
	    output.WriteElementString(DOUBLE,((double)obj).ToString(System.Globalization.CultureInfo.InvariantCulture));
	  }
